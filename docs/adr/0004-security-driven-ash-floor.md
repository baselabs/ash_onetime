...
## Amendment — patched dependency floors (2026-09-16, v1.3.0)
...
|---|---|---|
| Ash | 3.33.4 | [EEF-CVE-2026-86338](https://cna.erlef.org/osv/EEF-CVE-2026-86338.html) — fixed only in 3.33.4; 82752's 3.33.0 and the 82xxx batch's 3.32.2 sit below it |
...
The CI Ash matrix becomes `[3.33.4, latest]` (transiently both cells resolve 3.33.4
until the next Ash release — the same expected collapse as the 2026-08-18
amendment); the doctor and package checks use
